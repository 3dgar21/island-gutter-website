    ...
    <SectionWrapper id="gallery" title="Our Project Gallery" subtitle="See Our Work">
      ...
      <div className="text-center mt-12">
        ...
        <p className="text-muted-foreground mt-4">
          Want to see more of our work? <Link href="/gallery" className="text-primary hover:underline font-medium">Visit our full gallery</Link> or <Link href="/#contact" className="text-primary hover:underline font-medium">contact us</Link>.
        </p>
      </div>
    </SectionWrapper>
  );
